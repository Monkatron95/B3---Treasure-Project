        ...
        for landmark in self.world.landmarks:
            ...
            if d - 85 <= 4:
                ...
                if isFound:
                    ...
                    golds = canvas.create_image(landmark.x, landmark.y, image = gold, anchor = CENTER)

                    winsound.PlaySound(path+"/sound/sound.ogg", winsound.SND_ASYNC)               
                    print("Found")
                    self.score +=100
...
class Traffic: 
    ...
    def drawTraffic(self, canvas):
        ...
        self.shape3 = canvas.create_oval(self.x+5,self.y+43,self.x+20,self.y+58,fill='dark gray')
    ...
    def light (self):
        ...
        if t==40*(self.j+1):
                ...
                canvas.itemconfig(self.shape3, fill="dark gray")
...
traffic1 = Traffic(10, 559, 2, 'red')
traffic1.drawTraffic(canvas)

traffic2 = Traffic(970, 559, 1, 'red')
